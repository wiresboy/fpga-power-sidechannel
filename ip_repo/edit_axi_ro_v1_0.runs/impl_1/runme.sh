...
HD_PWD='D:/Github/fpga-power-sidechannel/ip_repo/edit_axi_ro_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ro_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_ro_v1_0.tcl -notrace
