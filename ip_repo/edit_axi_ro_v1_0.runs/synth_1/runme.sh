...
HD_PWD='D:/Github/fpga-power-sidechannel/ip_repo/edit_axi_ro_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ro_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ro_v1_0.tcl
