...
// Instantiation of Axi Bus Interface S00_AXI
	axi_ro_v1_0_S00_AXI # ( 
		...
		.ext_status(ext_status), //Is system currently collecting data for the FIFO?
		.last_ro_sum(last_ro_sum) //Most recent sum, mostly for debugging.
