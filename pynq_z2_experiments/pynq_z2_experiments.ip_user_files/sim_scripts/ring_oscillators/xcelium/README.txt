...
#
# Generated by export_simulation on Fri Nov 13 01:50:58 -0600 2020
#
################################################################################
...
'-reset_run' switch to the './ring_oscillators.sh' script.

./ring_oscillators.sh -reset_run
...
./ring_oscillators.sh -noclean_files

For more information on the script, please type './ring_oscillators.sh -help'.
