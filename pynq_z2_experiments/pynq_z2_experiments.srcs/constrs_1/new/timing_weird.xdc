...
set_false_path -from [get_pins {z2_voltage_experiments_i/axi_ro_control_0/inst/axi_ro_v1_0_S00_AXI_inst/slv_reg0_reg[*]/C}] -to [get_pins {z2_voltage_experiments_i/ring_oscillator_modu_0/inst/rom/ros/cycle_count_reg[*]/*}]
...
set_property ALLOW_COMBINATORIAL_LOOPS true  [get_nets -of_objects [get_cells {z2_voltage_experiments_i/power_virus_wrap_0/inst/pv/gen_size[*].gen_index[*].pvsRO/LUT2_PV_RO/I0}]]
set_property SEVERITY {Info}  [get_drc_checks LUTLP-1]
