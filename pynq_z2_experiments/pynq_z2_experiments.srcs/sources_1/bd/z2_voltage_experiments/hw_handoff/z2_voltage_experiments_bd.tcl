...
################################################################
# This is a generated script based on design: z2_voltage_experiments
#
...
# source z2_voltage_experiments_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# power_virus_fsm_wrap, power_virus_wrap, ring_oscillator_module_wrap
...
set design_name z2_voltage_experiments
...
proc create_root_design { parentCell } {
  ...
  set axi_ro_control_0 [ create_bd_cell -type ip -vlnv wiresboy.github.io:Brandon:axi_ro_control:1.1.1 axi_ro_control_0 ]
  ...
  # Create instance: power_virus_fsm_wrap_0, and set properties
  set block_name power_virus_fsm_wrap
  set block_cell_name power_virus_fsm_wrap_0
  if { [catch {set power_virus_fsm_wrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $power_virus_fsm_wrap_0 eq "" } {
  ...
  if { [catch {set power_virus_wrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.LOG_NUM_PV_INSTANCES {16} \
   CONFIG.PV_TYPE {0} \
 ] $power_virus_wrap_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_ro_control_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net axi_ro_control_0_num_power_virus_enabled [get_bd_pins power_virus_fsm_wrap_0/num_power_virus_enabled] [get_bd_pins power_virus_wrap_0/num_power_virus_enabled] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_3/Din]
  ...
  connect_bd_net -net ring_oscillator_modu_0_bram_we_a [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins ring_oscillator_modu_0/bram_we_a] [get_bd_pins xlconcat_0/In0]
