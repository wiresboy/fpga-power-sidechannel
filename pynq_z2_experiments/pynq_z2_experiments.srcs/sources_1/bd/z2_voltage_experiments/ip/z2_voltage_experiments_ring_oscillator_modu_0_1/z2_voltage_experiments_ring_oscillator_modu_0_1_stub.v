...
module z2_voltage_experiments_ring_oscillator_modu_0_1(clk_200MHz, rst_n, cycles_per_integration, 
  num_ro_enabled, aquire_mode, ro_rst, start_aquire, status, last_ro_sum, bram_addr_a, 
  bram_clk_a, bram_din_a, bram_we_a)
/* synthesis syn_black_box black_box_pad_pin="clk_200MHz,rst_n,cycles_per_integration[15:0],num_ro_enabled[15:0],aquire_mode,ro_rst,start_aquire,status[7:0],last_ro_sum[15:0],bram_addr_a[31:0],bram_clk_a,bram_din_a[31:0],bram_we_a" */;
  input clk_200MHz;
  input rst_n;
