...
#
# Generated by export_simulation on Fri Nov 13 01:56:51 -0600 2020
#
################################################################################
...
./ring_oscillators_axi_ro_control_0_0.sh
...
'-reset_run' switch to the './ring_oscillators_axi_ro_control_0_0.sh' script.

./ring_oscillators_axi_ro_control_0_0.sh -reset_run
...
./ring_oscillators_axi_ro_control_0_0.sh -noclean_files

For more information on the script, please type './ring_oscillators_axi_ro_control_0_0.sh -help'.
